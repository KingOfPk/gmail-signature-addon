      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-4xl mx-auto px-4 py-6">
          ...
          {showForm&&<div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
            ...
            <div className="mb-4"><p className="text-xs text-gray-500 mb-2">Quick Templates:</p><div className="flex gap-2">{["professional","minimal","withImage"].map(t=<(tbtn><button key={t} onClick={()=>loadTemplate(t)} className="text-xs bg-gray-100 hover:bg-gray-200 text-gray-600 px-3 py-1 rounded-full capitalize transition">{t}</button></tbtn>))}</div></div>
